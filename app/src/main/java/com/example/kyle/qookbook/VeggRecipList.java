...
public class VeggRecipList extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        adapt= new MyAdapter(VeggRecipList.this, recipelist);
...
//                        startActivity(intent);
                            try {
                                startActivity(new Intent(VeggRecipList.this, Class.forName(linky)));
